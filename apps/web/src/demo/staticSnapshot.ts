...
export const staticResearchSnapshot: StaticResearchSnapshot = {
    ...
    evidence: {
        ...
        n_day: 8,
        n_episode: 2,
        n_executed_episode: 2,
        daily_statistics: [
            {
                horizon_sessions: 252,
                independent: false,
                mean_total_return: 0.41,
                median_total_return: 0.37,
                win_rate: 0.75,
                expected_shortfall_5: -0.3,
                confidence_lower: 0.41,
                confidence_upper: 0.93,
                n: 8,
                overlap_warning: "Illustrative overlapping observations",
                sample_kind: "daily",
            },
        ],
        episode_statistics: [
            {
                ...
                median_total_return: 0.32,
                win_rate: 0.5,
                expected_shortfall_5: -0.18,
                confidence_lower: 0.09,
                confidence_upper: 0.91,
                n: 2,
        ...
        episodes: [
            ...
            },
            {
                cycle_id: 2,
                threshold: 0.3,
                peak_date: "2008-08-29",
                peak_price: 100,
                signal_date: "2008-10-10",
                signal_price: 69,
                signal_drawdown: -0.31,
                entry_date: "2008-10-13",
                entry_price: "31.00",
                recovery_date: null,
